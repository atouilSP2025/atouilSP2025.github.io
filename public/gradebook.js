...
async function fetchGradeData() {
    ...
    // Wrap the request in a Promise so we can use await
...
async function loadGradebook() {
    const gradeData = await fetchGradeData(); // Wait for data before populating
    populateGradebook(gradeData); // Then populate
}
